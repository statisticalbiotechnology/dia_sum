...
\begin{figure}[hbt]
   ...
   %\includegraphics[width=16cm]{../../result/2021-08-13_docs_plots/intensity_plot.png}
    ...
    \todo[inline]{RESPONSE: Because it is actually not top3 intensities in the x-values, but the mean intensity of the psms belonging to a protein for each group i.e. .groupby("proteins").intensity.mean(). Is this ok? or should I rewrite the code to have top3 intensities? LK: That is okay, you not making it clear from this figure is less optimal.}
\end{figure}
