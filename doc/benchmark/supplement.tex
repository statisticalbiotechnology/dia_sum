...
\begin{table}[h]
    ...
    \todo[inline]{At which FDR tresholds?}
\end{table}
...
\begin{figure}[hbt]
    ...
    \todo[inline]{FIXED - Capitals in the beginning of y-labels}
\end{figure}
...
\begin{figure}[hbt]
  ...
  \todo[inline]{FIXED - Capitals in beginning of y-label}
\end{figure}
...
\begin{figure}[hbt]
   ...
   %\includegraphics[width=16cm]{../../result/2021-08-13_docs_plots/intensity_plot.png}
    ...
    \todo[inline]{RESPONSE: Because it is actually not top3 intensities in the x-values, but the mean intensity of the psms belonging to a protein for each group i.e. .groupby("proteins").intensity.mean(). Is this ok? or should I rewrite the code to have top3 intensities?}
\end{figure}
...
\begin{figure}[hbt]
    ...
    \todo[inline]{FIXED - Remove legend in all but one subplot.}
    \todo[inline]{Harmonize font sizes.}
    \todo[inline]{FIXED - x-label Capital}
