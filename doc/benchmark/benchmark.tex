...
% OSW RESULTS
        A \includegraphics[width=0.41\linewidth]{../../result/report_plots/osw_sigma_mu_violinplot_qval_filtered_peptide_filtered_qbinned.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        B \includegraphics[width=0.49\linewidth]{../../result/report_plots/osw_fraction_missing_values.png} & \\%\includegraphics[width=0.3\linewidth]{} \\
...
\begin{figure}[hbt]
    ...
    \end{tabular}
    \todo[inline]{What does fc=0.4 mean here? Are you plotting the q-values estimated on a different list than the one you use here?}
