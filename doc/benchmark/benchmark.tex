...
Many DIA-NN users prefer to perform a LIMMA analysis on the protein group quantification matrices provided by the software. To perform the LIMMA-analysis we use the default empirical Bayes method for variance moderation to estimate variances in samples and compute differential expression \cite{limma}.  
