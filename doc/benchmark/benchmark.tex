...
\begin{figure}[H]
    ...
    \begin{tabular}{lclc} 
        ...
        C \includegraphics[width=0.5\linewidth]{../../result/report_plots/osw_fraction_missing_values.png}  & &%\includegraphics[width=0.3\linewidth]{} & 
        D \includegraphics[width=0.5\linewidth]{../../result/report_plots/diann_fraction_missing_values.png} & \\%\includegraphics[width=0.3\linewidth]{} \\ 
    \end{tabular}
