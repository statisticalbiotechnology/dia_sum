...
\begin{figure}[hbt]
    \centering
    \begin{tabular}{cc} 
        \includegraphics[width=0.3\linewidth]{../../result/2021-08-13_docs_plots/de_human_vs_de_specie.png} & 
        \includegraphics[width=0.3\linewidth]{../../result/2021-08-13_docs_plots/de_human_vs_de_specie.png} \\ 
        A & B
    \end{tabular}
