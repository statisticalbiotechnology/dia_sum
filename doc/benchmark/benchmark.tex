...
The peptide quantities was summarized to proteins using Top3, MSstats, MSqRobSum and Triqler for both the spectral library and the pseudo-spectra pipelines. 
...
We downloded MsStats version FIXME from \url{FIXME}.

\subsubsection*{MSqRobSum}

We downloded MSqRobSum version FIXME from \url{FIXME}.
