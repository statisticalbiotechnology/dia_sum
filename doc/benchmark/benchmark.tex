...
% OSW RESULTS
        A \includegraphics[width=0.42\linewidth]{../../result/report_plots/osw_sigma_mu_kde_qval_filtered_peptide_filtered_qbinned.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        B \includegraphics[width=0.44\linewidth]{../../result/report_plots/osw_fraction_missing_values.png} & \\%\includegraphics[width=0.3\linewidth]{} \\
