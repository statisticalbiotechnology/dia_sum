...
\begin{figure}[htp]
    ...
    \end{tabular}
    \todo[inline]{Add common output to both pipelines. The protein inference procedures are not part of your piplines, they are the entities tested.}
    \todo[inline]{The filter should be called a 1\% {\em PSM-level identification FDR} threshold}
...
\subsubsection*{Pseudo Spectra generation (PS)}
