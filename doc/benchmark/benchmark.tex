...
\begin{figure}[hbt]
    ...
    \begin{tabular}{lclc} 
        A \includegraphics[width=0.3\linewidth]{../../result/report_plots/osw_triqler_intensity.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        E \includegraphics[width=0.3\linewidth]{../../result/report_plots/diann_triqler_intensity.png} & \\%\includegraphics[width=0.3\linewidth]{} \\ 
        B \includegraphics[width=0.3\linewidth]{../../result/report_plots/osw_msqrobsum_intensity.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        F \includegraphics[width=0.3\linewidth]{../../result/report_plots/diann_msqrobsum_intensity.png} & \\%\includegraphics[width=0.3\linewidth]{} \\ 
        C \includegraphics[width=0.3\linewidth]{../../result/report_plots/osw_msstats_intensity.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        G \includegraphics[width=0.3\linewidth]{../../result/report_plots/diann_msstats_intensity.png} & \\%\includegraphics[width=0.3\linewidth]{} \\ 
        D \includegraphics[width=0.3\linewidth]{../../result/report_plots/osw_top3_intensity.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        H \includegraphics[width=0.3\linewidth]{../../result/report_plots/diann_top3_intensity.png} & %\includegraphics[width=0.3\linewidth]{} 
    \end{tabular}
...
\begin{figure}[hbt]
    ...
    \begin{tabular}{lclc} 
        ...
        %\includegraphics[width=0.3\linewidth]{../../result/report_plots/de_human_vs_de_specie.png} \\ 
        %A & B
        A \includegraphics[width=0.3\linewidth]{../../result/report_plots/osw_FP_DE_yeast.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        C \includegraphics[width=0.3\linewidth]{../../result/report_plots/diann_FP_DE_yeast.png} & \\%\includegraphics[width=0.3\linewidth]{} \\ 
        B \includegraphics[width=0.3\linewidth]{../../result/report_plots/osw_FP_DE_ecoli.png} & &%\includegraphics[width=0.3\linewidth]{} & 
        D \includegraphics[width=0.3\linewidth]{../../result/report_plots/diann_FP_DE_ecoli.png} & \\%\includegraphics[width=0.3\linewidth]{} \\ 
    \end{tabular}
...
\begin{figure}[hbt]
    ...
    \centering
    \begin{tabular}{cc} 
        \includegraphics[width=0.3\linewidth]{../../result/2021-08-13_docs_plots/calibration_plot.png} & 
        \includegraphics[width=0.3\linewidth]{../../result/2021-08-13_docs_plots/DIANN_calibration_plot.png} \\ 
        A & B
    \end{tabular}
    \caption{{\bf Comparison of calibration of the compared summarization methods.} We plotted the fraction of reported differentially abundant HeLa proteins as a function of $q$~value treshhold for (A) DDA generated spectral libraries and (B) DIA-Umpire geneated Pseudo spectra. \label{fig:frac_hela_vs_fdr}}
