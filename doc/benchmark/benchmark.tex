...
\begin{figure}[htp]
    ...
    \todo[inline]{make a common input to both piplines.}
    \todo[inline]{Add common output to both pipelines.}
    \todo[inline]{Add a common 1\% peptide-level identification FDR thresshold before all but triqler.}
...
\begin{figure}[hbt]
    ...
    \begin{tabular}{cc}
        ...
        C & D 
    \end{tabular}
    \todo[inline]{See to that you are using filtered data.}
...
\begin{figure}[hbt]
    ...
    \end{tabular}
    \todo[inline]{Label x/yt axis: "Differential {\em E. Coli}+Yeast proteins", and "Differential HeLa proteins"}   
