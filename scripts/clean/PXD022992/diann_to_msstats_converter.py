...
def convert_diann_to_msconvert_aggregated(df):
    ...
    df_["BioReplicate"] = df.Run
    df_["Condition"] = df.Run.map({'201905024_F_7951_pro_1':"M", '201905024_F_7951_pro_2':"M",
    '201905024_F_SH4_pro_1':"M", '201905024_F_SH4_pro_2':"M",
    '201905024_F_HTB69_pro_1':"M", '201905024_F_HTB69_pro_2':"M",
    '201905024_S_SK_pro_1':"P", '201905024_S_SK_pro_2':"P",
    '201905024_S_A375_pro_1':"P", '201905024_S_A375_pro_2':"P",
    '201905024_S_G361_pro_1':"P", '201905024_S_G361_pro_2':"P"})
    df_["Run"] = df.Run
    df_["BioReplicate"] = df_["BioReplicate"].map({'201905024_F_7951_pro_1':1, '201905024_F_7951_pro_2':2,
    '201905024_F_SH4_pro_1':3, '201905024_F_SH4_pro_2':4,
    '201905024_F_HTB69_pro_1':5, '201905024_F_HTB69_pro_2':6,
    '201905024_S_SK_pro_1':1, '201905024_S_SK_pro_2':2,
    '201905024_S_A375_pro_1':3, '201905024_S_A375_pro_2':4,
    '201905024_S_G361_pro_1':5, '201905024_S_G361_pro_2':6})
...
def convert_diann_to_msstats(input_file = "report_recomputed_fdr.tsv", output = "msstats_input.csv", fdr_threshold = 0.01, qCol = "q"):
    ...
    df = filter_on_max_peptide(df, n_peptides = 200) # 93395
