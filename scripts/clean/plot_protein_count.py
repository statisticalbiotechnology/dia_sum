...
# -*- coding: utf-8 -*-
"""
Created on Wed May 18 11:11:56 2022
...
if __name__ == "__main__":
    ...
    if specie == "all":
        ...
        ax.set_ylabel("Protein count non-HeLa", fontsize = 38)
    elif specie == "yeast":
        sns.lineplot(x = negCol, y = posCol, hue = "method", data = df_count, ax = ax, linewidth = 5)
        ax.set_ylabel("Protein count yeast", fontsize = 38)
    elif specie == "ecoli":
        sns.lineplot(x = negCol, y = posCol, hue = "method", data = df_count, ax = ax, linewidth = 5)
        ax.set_ylabel("Protein count ecoli", fontsize = 38)
    ax.set_xlim(-1,200)

    ax.set_xlabel("Protein count HeLa", fontsize=34)
