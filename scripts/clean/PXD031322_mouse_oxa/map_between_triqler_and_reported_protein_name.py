...
triqler_results_dir = "2022-08-11_run/triqler_results/fc_0.4/proteins_fc_0.4_triqler_input_report_1.tsv"
report_results = "reported_significant_diff_abundant_ST_vs_CTRL.xlsx"
...
plt.title("Venn diagram of differentially abundant proteins, FDR < 0.001")
plt.show()
