...
c1_bgr_mapped = get_mapped_proteins(ids = list(c1_bgr.index))
c2_bgr_mapped = get_mapped_proteins(ids = list(c2_bgr.index))
c3_bgr_mapped = get_mapped_proteins(ids = list(c3_bgr.index))
c4_bgr_mapped = get_mapped_proteins(ids = list(c4_bgr.index))
c5_bgr_mapped = get_mapped_proteins(ids = list(c5_bgr.index))
c6_bgr_mapped = get_mapped_proteins(ids = list(c6_bgr.index))
...
plot_dotplot(df = plot_input, size = 15, title = "KEGG_2019_mouse, fc_eval = 0.415, fdr = 0.05")
plot_dotplot(df = plot_input_paper_term, size = 15, title = "KEGG_2019_mouse, fc_eval = 0.415, fdr = 0.05")

df.to_csv("enrichr_triqler_fc_0.6_subcluster_bgr.tsv", sep = "\t", index = False)
