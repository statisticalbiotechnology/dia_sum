...
n_ecoli = len(df_final[df_final.index.get_level_values("specie") == "ECOLI"])
n_yeast = len(df_final[df_final.index.get_level_values("specie") == "YEAS8"])
n_human = len(df_final[df_final.index.get_level_values("specie") == "HUMAN"])

ecoli_scale = n_human/n_ecoli
yeast_scale = n_human/n_yeast
