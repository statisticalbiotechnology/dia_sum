...
msqrob2.id <- function(input, output){
  peptidesFile <- input
...
msqrob2.id(input = "/home/ptruong/git/dia_sum/scripts/clean/data/ID/msqrob2_input/msqrob2_input_20220204.tsv",
           output = "/home/ptruong/git/dia_sum/scripts/clean/data/ID/msqrob2_input/tmp/test.tsv")