...
def read_in_files(triqler_file = "triqler_results/fc_0.96",
    ...
    limma_results = pd.read_csv(limma_file, sep = "\t").rename({"Unnamed: 0":"Protein"},axis=1)
    ...
    limma_results = limma_results.rename({"adj.P.Val":"FDR", "logFC":"log2FC", "P.Value":"p"}, axis = 1)    
    
    methods = ["Triqler", "Top3", "MsStats", "MsqRob2", "Limma"]
    data = [triqler_results, top3_results, msstats_results, msqrob2_results, limma_results]
