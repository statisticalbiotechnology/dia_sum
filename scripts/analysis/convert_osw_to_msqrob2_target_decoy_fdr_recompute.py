...
def convert_osw_to_msqrob2(input_file, output, fdr_threshold):
...
parser.add_argument('--fdr_threshold_threshold', type=float,
...
fdr_threshold_threshold = args.fdr_threshold_threshold
output = args.output
      
if __name__ == "__main__":
    convert_osw_to_msqrob2(input_file, output, fdr_threshold_threshold)
