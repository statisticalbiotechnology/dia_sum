...
if __name__ == "__main__":
    ...
    parser.add_argument('--msstats_input_file', type=str,
                        help='Scatterplot converter input file from msstats.')

    parser.add_argument('--msstats_protein_quant_result_file', type=str,
                        help='MSstats protein quant results file.')
    ...
    input_file = args.msstats_input_file
    result_file = args.msstats_result_file
    output = args.output
    step = args.step
    df = pd.read_csv(input_file, sep = "\t")
