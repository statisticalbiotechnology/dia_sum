...
python plot_differential_protein_vs_entrapment.py --triqler_input data/triqler_results.tsv --top3_input data/top3_results.csv --msstats_input data/msstats_results.csv --msqrob2_input data/msqrob2_results.csv --fc_threshold 0.63 --output data/diff_entrapment_fc_0.63.png
